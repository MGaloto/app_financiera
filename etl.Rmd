...
MELI=as.data.frame(
  getSymbols(
    "CATD.BA" , src = 'yahoo', auto.assign = F, from = "2001-01-02", to = Sys.Date(), periodicity = "daily"
    )
  )
...
cedears_claves <- paste0(names(cedears), ".BA")


resultado <- crear_dataframe(cedears_claves)
